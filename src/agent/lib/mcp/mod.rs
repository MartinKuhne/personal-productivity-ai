...
//! | Lifecycle — timeouts          | Implemented (60s default)                                     |
...
//! | Authorization — Token cache   | Implemented (file-level permissions)                         |
...
impl McpClients {
    ...
    pub fn update_config(&self, config: &crate::config::AgentConfig) {
