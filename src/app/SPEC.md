...
- [REQ-001] The system shall offer an `About...` entry in the 'hamburger' menu.
- [REQ-002] When the user selects the `About...` entry, the system shall display the `About` dialog.
- [REQ-003] The `About` dialog SHALL display the application name and a copyright notice.
- [REQ-004] The `About` dialog SHALL contain the build branch, commit hash and build date.
- [REQ-005] The `About` dialog SHALL contain a full copy of the application license (scrollable).
- [REQ-006] The `About` dialog SHALL contain a list of attributions for all the direct dependencies of the fastmd crates.
- [REQ-007] The dependency attributions shall contain their library names, authors (if known) and the github project URLs.
- [REQ-010] When the application starts for the first time, it SHALL display the `About` dialog.
